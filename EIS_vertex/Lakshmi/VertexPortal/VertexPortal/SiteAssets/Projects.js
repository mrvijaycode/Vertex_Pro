...
function RetrieveListItems(){	
    ...
    while (listEnumerator.moveNext()) { 
		...
		items.push('<td class="inner_table_flip" align="left" valign="middle"><a onclick="Edit(' + item.get_id() + ')"><img alt="Edit" src="http://inhydpc151:55555/Style%20Library/Images/edit.png" width="14" height="16" /></a></td>');
		items.push('<td class="inner_table_flip" align="left" valign="middle"><a onclick="Delete(' + item.get_id() + ')"><img alt="Delete" src="http://inhydpc151:55555/Style%20Library/Images/delete_icon.png" width="14" height="16" /></a></td></tr>');
...
RetrieveListItems();
flag=1;
$('#sortingimage').attr('src', "http://inhydpc151:55555/Style%20Library/Images/Uparrow.jpg");
}
else if(flag=="1"){
...
context = SP.ClientContext.get_current(); 
    ...
    $('#sortingimage').attr('src', "http://inhydpc151:55555/Style%20Library/Images/downarrow.jpg");
