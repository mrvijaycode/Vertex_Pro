    ...
    public class VertexBrandEventReceiver : SPFeatureReceiver
    {
        ...
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            if (siteCollection != null)
            {
                ...
                //to create the group
                /*
                SPUser oUser = topLevelSite.Users[@"vertexcs\vijaybhaskar.c"];
                SPMember oMember = topLevelSite.Users[@"vertexcs\vijaybhaskar.c"];

                collGroups.Add("HR", oMember, oUser, "Created using Visual Studio");

                SPGroup admGrp = topLevelSite.SiteGroups["HR"];
                //You can change "Full Control" to Read, Design, or Contribute:
                SPRoleDefinition role = topLevelSite.RoleDefinitions["Full Control"];
                SPRoleAssignment roleAssignment = new SPRoleAssignment(admGrp);
                roleAssignment.RoleDefinitionBindings.Add(role);
                topLevelSite.RoleAssignments.Add(roleAssignment);
                topLevelSite.Update();
                */
        ...
        public override void FeatureDeactivating(SPFeatureReceiverProperties properties)
        {
            ...
            if (siteCollection != null)
            {
                ...
                /*
                SPGroupCollection collGroups = topLevelSite.SiteGroups;
                SPGroup admgrp = collGroups["HR"];
                topLevelSite.SiteGroups.Remove("HR");
                topLevelSite.Update();
                */
